...
public class AffichageRoles extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_affichage_roles);

        listView = findViewById(R.id.ListRoles);
        adapter = new RolesAdapter(this, new JSONArray());
                        ...
                        try {
                            ...
                            listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                                ...
                                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                                    JSONObject selectedRole = adapter.getItem(position);
                                    if (selectedRole != null) {
                                        try {
                                            String idSelected = selectedRole.getString("id");
    ...
    private void showAlertDialog(final String roleId) {
        AlertDialog.Builder builder = new AlertDialog.Builder(this);
        builder.setTitle("Alert Dialog");
        builder.setMessage("Vous avez sélectionné le role : " + roleId);
    ...
    private void showConfirmationDialog(final String roleId) {
        AlertDialog.Builder builder = new AlertDialog.Builder(this);
        builder.setTitle("Confirmation de suppression");
        builder.setMessage("Êtes-vous sûr de supprimer l'élément  : " + roleId);
