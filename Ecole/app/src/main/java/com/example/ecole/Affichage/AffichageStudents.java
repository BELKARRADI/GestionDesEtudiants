...
import com.example.ecole.adapters.StudentAdapter;

import org.json.JSONArray;
import org.json.JSONException;
import org.json.JSONObject;

public class AffichageStudents extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_affichage_students);

        listView = findViewById(R.id.ListStudents);
        adapter = new StudentAdapter(this, new JSONArray());
    ...
    private void showAlertDialog(final String studentId) {
        AlertDialog.Builder builder = new AlertDialog.Builder(this);
        builder.setTitle("Alert Dialog");
        builder.setMessage("Vous avez sélectionné la filiere : " + studentId);
    ...
    private void showConfirmationDialog(final String studentId) {
        ...
        builder.setMessage("Êtes-vous sûr de supprimer l'etudiant Num  : " + studentId);
    ...
    private void deleteStudent(String studentId) {
        ...
        String deleteUrl = "http://10.0.2.2:8082/api/Student/"+studentId;
